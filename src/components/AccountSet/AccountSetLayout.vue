  ...
  <div class="account-set-layout">
    ...
    <el-row class="tac">
      <el-col :span="4">
        ...
        <el-menu class="bonus-menu" background-color="#0A0E22" text-color="#989AA2" active-text-color="#fff" router="router">
          ...
          <el-menu-item index="1" route="/accountSet" class="home-page-wrap" v-bind:class="{ isActive: (thisPath === '/accountSet') }">
            <img class="menu-icon home-icon" src="../../assets/accountSet/accountSet.png">
      ...
      <el-col :span="20" class="bonus-content">
        <div class="title">
          <img v-if="thisPath === '/bindWallet'" class="title-img" src="../../assets/accountSet/walletBlack.png" />
          <img v-if="thisPath === '/accountSet'" class="title-img" src="../../assets/accountSet/accountBlack.png" />
          {{layoutTitile}}
        </div>
        <div>
        </div>
